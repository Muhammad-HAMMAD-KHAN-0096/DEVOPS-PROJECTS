...
Two ECR repos will be created where we will have docker image for application and presentation tier .First of all we have AWS Cloud, inside this we have VPC in which we will deploy our resources.Here we have two availability zones.We have 2 public and two private subnets.two LBs will be deployed using IAC.One lB for UI and one LB for backend, after this we have our DB.
# <ins>ECR REPOS</ins>
